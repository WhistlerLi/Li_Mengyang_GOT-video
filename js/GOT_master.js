(() => {
  ...
  const houseData = [ // houseData[0][0] -> this is the house name ("stark")
      ...
      // houseData[6][0] is "frey", houseData[6][1] is the house data
      ...
      // houseData[7][0] is "tyrell", houseData[7][1] is the house data
      ["tyrell", `House Tyrell of Highgarden is an extinct Great House of Westeros. It ruled over the Reach, a vast, fertile, and heavily-populated region of southwestern Westeros, from their castle-seat of Highgarden as Lords Paramount of the Reach and Wardens of the South after taking control of the region from House Gardener during the Targaryen conquest. The Tyrell sigil is a golden rose on a pale green field. Their house words are Growing Strong. Under Olenna, House Tyrell realigned itself with House Targaryen and declared for Daenerys Targaryen in opposition against Cersei Lannister, who had orchestrated the downfall of House Tyrell. With the death of Olenna after the Sack of Highgarden, the House has officially become extinct.`],

      // houseData[8][0] is "targaryen", houseData[8][1] is the house data
